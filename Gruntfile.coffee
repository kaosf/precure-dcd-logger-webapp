...
module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    concurrent:
      server: ["jade", "compass", "coffee:dist"]
      test: ["jade", "coffee"]
      dist: ["jade", "coffee", "compass", "imagemin", "svgmin", "htmlmin"]
  ...
  grunt.registerTask "build", ["clean:dist", "jade", "useminPrepare", "concurrent:dist", "concat", "cssmin", "uglify", "copy:dist", "rev", "usemin"]
